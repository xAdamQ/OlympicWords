...
namespace OlympicWords.Migrations
{
    ...
    [Migration("20230130174522_jsonCol")]
    partial class jsonCol
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlympicWords.Data.User", b =>
                {
                    b.OwnsOne("System.Collections.Generic.Dictionary<string, string>", "SelectedPlayers", b1 =>
                        {
                            ...
                            b1.ToJson("SelectedPlayers");

                            b1.WithOwner()
                                .HasForeignKey("UserId");
                        });

                    b.OwnsOne("System.Collections.Generic.HashSet<string>", "OwnedPlayers", b1 =>
                        {
                            b1.Property<string>("UserId")
                                .HasMaxLength(128)
                                .HasColumnType("nvarchar(128)");
                            ...
                            b1.ToJson("OwnedPlayers");

                            b1.WithOwner()
                                .HasForeignKey("UserId");
                        });

                    b.OwnsOne("UserItemPlayers", "ItemPlayers", b1 =>
                        {
                            b1.Property<string>("UserId")
                                .HasMaxLength(128)
                                .HasColumnType("nvarchar(128)");
                            ...
                            b1.ToJson("ItemPlayers");

                            b1.WithOwner()
                                .HasForeignKey("UserId");

                            b1.OwnsOne("System.Collections.Generic.List<string>", "Owned", b2 =>
                                {
                                    b2.Property<string>("UserItemPlayersUserId")
                                        .HasMaxLength(128)
                                        .HasColumnType("nvarchar(128)");
                                    ...
                                    b2.HasKey("UserItemPlayersUserId");
                                    ...
                                    b2.WithOwner()
                                        .HasForeignKey("UserItemPlayersUserId");
                                });

                            b1.OwnsOne("UserItemPlayers.Selected#Dictionary", "Selected", b2 =>
                                {
                                    b2.Property<string>("UserItemPlayersUserId")
                                        .HasMaxLength(128)
                                        .HasColumnType("nvarchar(128)");
                            ...
                            b1.Navigation("Selected");
                        });

                    b.Navigation("ItemPlayers");

                    b.Navigation("OwnedPlayers");
