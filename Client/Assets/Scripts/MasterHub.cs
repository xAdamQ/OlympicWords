...
public interface IMasterHub
{
    ...
    Task<FullUserView.MatchRequestResult> RequestMatch(string oppoId);
...
public class MasterHub : MonoModule<MasterHub>, IMasterHub
{
    ...
    public Task<FullUserView.MatchRequestResult> RequestMatch(string oppoId)
    {
        return NetManager.I.InvokeAsync<FullUserView.MatchRequestResult>(oppoId);
    }
    ...
    public Task Ready()
    {
        return NetManager.I.SendAsync(nameof(Ready));
    }
    ...
    {
        return NetManager.I.SendAsync(nameof(Surrender));
    }
